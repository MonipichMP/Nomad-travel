...
! function (t, n) {
    ...
    function a(t, n, e, r, i, o) {
        for (var u, c = 0, a = n.length, l = o.length; c < l; ++c)(u = n[c]) ? (u.__data__ = o[c], r[c] = u) : e[c] = new s(t, o[c]);
        for (; c < a; ++c)(u = n[c]) && (i[c] = u)
    }
    ...
    function l(t, n, e, r, i, o, u) {
        var c, a, l, f = {},
            ...
            p = o.length,
            _ = new Array(h);
        for (c = 0; c < h; ++c)(a = n[c]) && (_[c] = l = X + u.call(a, a.__data__, c, n), l in f ? i[c] = a : f[l] = a);
        for (c = 0; c < p; ++c)(a = f[l = X + u.call(t, o[c], c, o)]) ? (r[c] = a, a.__data__ = o[c], f[l] = null) : e[c] = new s(t, o[c]);
        for (c = 0; c < h; ++c)(a = n[c]) && f[_[c]] === a && (i[c] = a)
    }
    ...
    function L(t, n, e) {
        var r = Y.hasOwnProperty(t.type) ? C : P;
        return function (i, o, u) {
            var c, s = this.__on,
                a = r(n, o, u);
            if (s)
                for (var l = 0, f = s.length; l < f; ++l)
                    if ((c = s[l]).type === t.type && c.name === t.name) return this.removeEventListener(c.type, c.listener, c.capture), this.addEventListener(c.type, c.listener = a, c.capture = e), void (c.value = n);
    ...
    if ("undefined" != typeof document) {
        ...
        if (!U.matches) {
            var k = U.webkitMatchesSelector || U.msMatchesSelector || U.mozMatchesSelector || U.oMatchesSelector;
            I = function (t) {
                return function () {
    ...
    if (t.event = null, "undefined" != typeof document) {
        "onmouseenter" in document.documentElement || (Y = {
    ...
    B.prototype = q.prototype = {
        ...
        select: function (t) {
            ...
            for (var n = this._groups, e = n.length, r = new Array(e), o = 0; o < e; ++o)
                for (var u, c, s = n[o], a = s.length, l = r[o] = new Array(a), f = 0; f < a; ++f)(u = s[f]) && (c = t.call(u, u.__data__, f, s)) && ("__data__" in u && (c.__data__ = u.__data__), l[f] = c);
            return new B(r, this._parents)
        },
        selectAll: function (t) {
            "function" != typeof t && (t = u(t));
            for (var n = this._groups, e = n.length, r = [], i = [], o = 0; o < e; ++o)
                for (var c, s = n[o], a = s.length, l = 0; l < a; ++l)(c = s[l]) && (r.push(t.call(c, c.__data__, l, s)), i.push(c));
            return new B(r, i)
        },
        filter: function (t) {
            "function" != typeof t && (t = G(t));
            for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i)
                for (var o, u = n[i], c = u.length, s = r[i] = [], a = 0; a < c; ++a)(o = u[a]) && t.call(o, o.__data__, a, u) && s.push(o);
            return new B(r, this._parents)
        },
        data: function (t, n) {
            ...
            for (var o = i.length, u = new Array(o), c = new Array(o), s = new Array(o), f = 0; f < o; ++f) {
                var h = r[f],
                    p = i[f],
                    _ = p.length,
                    d = t.call(h, h && h.__data__, f, r),
                    v = d.length,
                    m = c[f] = new Array(v),
                    y = u[f] = new Array(v);
                e(h, p, m, y, s[f] = new Array(_), d, n);
                for (var g, w, A = 0, x = 0; A < v; ++A)
                    if (g = m[A]) {
                        for (A >= x && (x = A + 1); !(w = y[x]) && ++x < v;);
                        g._next = w || null
                    }
            }
            return u = new B(u, r), u._enter = c, u._exit = s, u
        },
        enter: function () {
            return new B(this._enter || this._groups.map(c), this._parents)
        },
        exit: function () {
            return new B(this._exit || this._groups.map(c), this._parents)
        },
        merge: function (t) {
            for (var n = this._groups, e = t._groups, r = n.length, i = e.length, o = Math.min(r, i), u = new Array(r), c = 0; c < o; ++c)
                for (var s, a = n[c], l = e[c], f = a.length, h = u[c] = new Array(f), p = 0; p < f; ++p)(s = a[p] || l[p]) && (h[p] = s);
            for (; c < r; ++c) u[c] = n[c];
        ...
        attr: function (t, e) {
            ...
            return this.each((null == e ? r.local ? function (t) {
                return function () {
            ...
            } : "function" == typeof e ? r.local ? function (t, n) {
                return function () {
        ...
        classed: function (t, n) {
            ...
            return this.each(("function" == typeof n ? function (t, n) {
                return function () {
                    (n.apply(this, arguments) ? m : y)(this, t)
                }
            } : n ? function (t) {
                return function () {
                    m(this, t)
        ...
        insert: function (t, n) {
            var r = "function" == typeof t ? t : e(t),
                o = null == n ? S : "function" == typeof n ? n : i(n);
            return this.select(function () {
        ...
        on: function (t, n, e) {
            var r, i, o = function (t) {
                ...
                u = o.length;
            if (!(arguments.length < 2)) {
                for (c = n ? L : M, null == e && (e = !1), r = 0; r < u; ++r) this.each(c(o[r], n, e));
                return this
            }
    ...
    V.prototype = D.prototype = {
        ...
        return O(e(t).call(document.documentElement))
    }, t.creator = e, t.local = D, t.matcher = G, t.mouse = function (t) {
        var n = R();
        return n.changedTouches && (n = n.changedTouches[0]), j(t, n)
    }, t.namespace = n, t.namespaces = H, t.clientPoint = j, t.select = O, t.selectAll = function (t) {
        return "string" == typeof t ? new B([document.querySelectorAll(t)], [document.documentElement]) : new B([null == t ? [] : t], $)
    }, t.selection = q, t.selector = i, t.selectorAll = u, t.style = p, t.touch = function (t, n, e) {
        arguments.length < 3 && (e = n, n = R().changedTouches);
        for (var r, i = 0, o = n ? n.length : 0; i < o; ++i)
            if ((r = n[i]).identifier === e) return j(t, r);
        return null
    }, t.touches = function (t, n) {
        null == n && (n = R().touches);
        for (var e = 0, r = n ? n.length : 0, i = new Array(r); e < r; ++e) i[e] = j(t, n[e]);
        return i
    }, t.window = h, t.customEvent = function (n, e, r, i) {
        var o = t.event;
